...
public class Peral extends Fragment {
    RecyclerView recycler;
    ProgressDialog progressDialog;
    private static final String url="http://teamdoers.in/admin/webservices/pearl_ranker.php";
    int numberOfColumns=2;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_peral, container, false);
        recycler = view.findViewById(R.id.recyclerperal);
