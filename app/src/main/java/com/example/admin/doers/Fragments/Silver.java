...
import com.example.admin.doers.GridSpacingItemDecoration;
...
public class Silver extends Fragment {

private static final String url="http://teamdoers.in/admin/webservices/gold_ranker.php";
ProgressDialog progressDialog;
RecyclerView recycler;
LinearLayoutManager linearLayoutManager;
Silver_Adapter silver_adapter;
Silver_model[] users;
...
int spacing = 5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recycler=view.findViewById(R.id.recyclersilver);
        recycler.setLayoutManager(new GridLayoutManager(getContext(),numberOfColumns));
        recycler.addItemDecoration(new GridSpacingItemDecoration(numberOfColumns,spacing,includeEdge));
