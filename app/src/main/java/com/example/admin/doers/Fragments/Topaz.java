...
public class Topaz extends Fragment {

    RecyclerView recycler;
    ProgressDialog progressDialog;
    private static final String url="http://teamdoers.in/admin/webservices/topaz_ranker.php";
    int numberOfColumns=2;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_topaz, container, false);
        recycler = view.findViewById(R.id.recyclertopaz);
